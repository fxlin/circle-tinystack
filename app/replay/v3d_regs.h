...
//#define V3D_HUB_BASE 	0x7ec00000
#define V3D_CORE_BASE 0xfec04000
...
#define V3D_HUB_INT_STS                                0x00050 // xzl: hub irq status?
...
# define V3D_HUB_INT_MMU_WRV                           BIT(5) // xzl: mmu write violation
# define V3D_HUB_INT_MMU_PTI                           BIT(4) // xzl: pte invalid
# define V3D_HUB_INT_MMU_CAP                           BIT(3) // xzl: cap exceeded
# define V3D_HUB_INT_MSO                               BIT(2)
# define V3D_HUB_INT_TFUC                              BIT(1) // xzl: tfu complete?
...
// xzl: these input addr can be useful. but how about their sizes?
/* Input Image Address */
...
# define V3D_MMUC_CONTROL_FLUSHING                     BIT(2) // xzl: 1-MMUC flush ongoing
...
# define V3D_MMU_CTL_TLB_CLEARING                      BIT(7) // xzl:r 1-TLB clear ongoing
# define V3D_MMU_CTL_TLB_STATS_CLEAR                   BIT(3)
# define V3D_MMU_CTL_TLB_CLEAR                         BIT(2) // xzl:w 1-clear TLB
...
// xzl: L2 texture cache control?
#define V3D_CTL_L2TCACTL                               0x00030
# define V3D_L2TCACTL_TMUWCF                           BIT(8) // xzl: write = l1t flush?
...
// xzl: read =1 means flush/clean busy? write 1 triggers flush/clean/clear, which is
// 	determined by FLM fields?
...
# define V3D_INT_FLDONE                                BIT(1) // xzl: bin cl done?
# define V3D_INT_FRDONE                                BIT(0) // xzl: render cl done?
...
// xzl: CT0 - bin CL? CT1 - render CL?
#define V3D_CLE_CT0QBA                                 0x00160 // xzl:begin addr
#define V3D_CLE_CT1QBA                                 0x00164 // xzl: end addr
#define V3D_CLE_CTNQBA(n) (V3D_CLE_CT0QBA + 4 * n)
#define V3D_CLE_CT0QEA                                 0x00168 // xzl: triggers bcl
...
// xzl: overflow start addr? overflow size?
...
#define V3D_CSD_CURRENT_CFG4                          0x00930  // xzl: job batches? only used in timedout. read=remaining batches?
